...
//!	Generated Date	: Tue, 14, Apr 2020 
	File Path	: EXE/Host/Default/Dishwasher.java
*********************************************************************/
...
public class Dishwasher implements RiJStateConcept, Animated {
    ...
    public static AnimClass animClassDishwasher = new AnimClass("Default.Dishwasher",false);
    //#]
    ...
    public class Reactive extends RiJStateReactive implements AnimatedReactive {
        ...
        public int Running_takeEvent(short id) {
            int res = RiJStateReactive.TAKE_EVENT_NOT_CONSUMED;
            if(event.isTypeOf(evOpen.evOpen_Default_id))
                {
        ...
        public int Open_takeEvent(short id) {
            int res = RiJStateReactive.TAKE_EVENT_NOT_CONSUMED;
            if(event.isTypeOf(evClose.evClose_Default_id))
                {
                    res = OpenTakeevClose();
                }
        ...
        public int Off_takeEvent(short id) {
            int res = RiJStateReactive.TAKE_EVENT_NOT_CONSUMED;
            if(event.isTypeOf(evStart.evStart_Default_id))
                {
                    res = OffTakeevStart();
                }
