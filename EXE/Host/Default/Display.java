...
//!	Generated Date	: Tue, 14, Apr 2020 
	File Path	: EXE/Host/Default/Display.java
*********************************************************************/
...
import com.telelogic.dishwasher.KeyReader;
//## auto_generated
...
public class Display implements RiJStateConcept, Animated {
    ...
    public static AnimClass animClassDisplay = new AnimClass("Default.Display",false);
    //#]
    ...
    */
    ...
    public class Reactive extends RiJStateReactive implements AnimatedReactive {
        ...
        public int WaitForKeys_takeEvent(short id) {
            int res = RiJStateReactive.TAKE_EVENT_NOT_CONSUMED;
            if(event.isTypeOf(evKeyPress.evKeyPress_Default_id))
                {
